...
export default function BpmnRenderer(
  ...
  function renderEmbeddedLabel(parentGfx, element, align, attrs) {
    ...
    const box = {
      x: attrs.x || element.x,
      y: attrs.y || element.y,
      width: attrs.width || element.width,
      height: attrs.height || element.height
    };
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:Activity': function(parentGfx, element, attrs) {
      ...
      return drawRect(parentGfx, attrs.width || element.width, attrs.height || element.height, TASK_BORDER_RADIUS, attrs);
    },
